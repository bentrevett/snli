...
training = get_data('data/snli_1.0/snli_1.0_train.jsonl')
validation = get_data('data/snli_1.0/snli_1.0_dev.jsonl')
test = get_data('data/snli_1.0/snli_1.0_test.jsonl')
